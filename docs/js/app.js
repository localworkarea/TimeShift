(() => {
    ...
    function initSliders() {
        if (document.querySelector(".what-slider")) new Swiper(".what-slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (lngMenu) if (!isMobile.any()) {
            ...
            document.addEventListener("click", (e => {
                if (!lngMenu.contains(e.target)) lngMenu.classList.remove("_show");
            }));
        }
    }));
    window["FLS"] = false;
